...
import type { Manager, Pillar, KPI, AnalysisResult, ManagerRole, Recommendation, RiskProfile } from '../data.tsx';
import type { ExecutiveTab, ManagerWithData } from '../types.tsx';
